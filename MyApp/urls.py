...
from .views import home, resources, Register, LoginView, logout_view, settings_page, update_profile_settings, change_password, find_help, account_view, delete_account, update_email, update_role
