...
class RequestWorkflowTests(TestCase):
    ...
    #Claiming request sets status, claimer, and timestamp
    ...
    #Update claimed request reopens it and sends notification
    ...
    #deleting claimed reqeusts sends notification
    @patch("MyApp.views.send_system_dm")
    ...
    #Verifying request marks fulfilled and sends notification
    @patch("MyApp.views.send_system_dm")
    ...
    #Volunteer withdrawal reopens request and sends notification
    @patch("MyApp.views.send_system_dm")
